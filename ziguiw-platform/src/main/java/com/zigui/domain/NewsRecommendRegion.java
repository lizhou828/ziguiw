...
@Entity
@Table(name="news_recommend_region")
@SequenceGenerator(
    name="NEWS_RECOMMEND_REGION_SEQ",
    sequenceName="news_recommend_region_seq",
    allocationSize=1
)
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class NewsRecommendRegion implements Serializable{

	private static final long serialVersionUID = 6908614831055362188L;
	
	private static final DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd HH:mm");

	@Id
	@GeneratedValue(strategy= GenerationType.SEQUENCE,generator="NEWS_RECOMMEND_REGION_SEQ")
	private long id;

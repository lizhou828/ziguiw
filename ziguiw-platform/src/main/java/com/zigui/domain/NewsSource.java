...
@SequenceGenerator(name = "NEWS_SOURCE_SEQ", sequenceName = "news_source_seq", allocationSize = 1)
...
public class NewsSource implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "NEWS_SOURCE_SEQ")
	private long id;
	...
	public String toString() {
		return "NewsSource [id=" + id + ", name=" + name + ", state=" + state
				+ ", creatorId=" + creatorId + ", creatorNick=" + creatorNick
				+ ", createTime=" + createTime + ", lastModifyId="
				+ lastModifyId + ", lastModifyNick=" + lastModifyNick

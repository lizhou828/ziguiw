...
public class News implements Serializable{
	...
	private static final long serialVersionUID = -2063983106666422339L;
	...
	public String toString() {
		return "News [id=" + id + ", title=" + title + ", newsChannle="
				+ newsChannle + ", newsRecommendRegion=" + newsRecommendRegion

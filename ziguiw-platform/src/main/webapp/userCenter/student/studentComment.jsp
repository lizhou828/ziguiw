...
<div class="uc_midd">
    ...
    <div class="uc_right">
        ...
        <div class="right">
            <form action="/userCenter/studentCommentList.action"  id="studentCommentList" method="post">


                <%--<input type="hidden" name="msgtype" id="msgtype" value="3"/>--%>

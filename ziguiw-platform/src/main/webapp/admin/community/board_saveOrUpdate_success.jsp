...
document.write("亲，您已成功新增/修改版区！快去看看都有哪些版区吧！");

document.write("<br /><a href='<%=path%>/admin/community/board_listByCondition_success.jsp?opType=0'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/community/board_listByCondition_success.jsp?opType=0")',5000);</script>

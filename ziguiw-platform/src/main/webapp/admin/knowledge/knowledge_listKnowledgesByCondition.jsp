   ...
   <s:action var="action1" name="knowledgeChannle_getAll" namespace="/admin/knowledge" executeResult="false" ignoreContextParams="false">
	...
	<tr>
		...
		<td>
			...
			|
			<a href="<%=path%>/admin/knowledge/knowledge_fakeDelete.action?opIds=<s:property value="#knowledge.id"/>">删除</a>
		</td>
...
<s:action var="queryAllRecommendRegion" name="knowledgeRecommendRegion_getAll" namespace="/" executeResult="false" ignoreContextParams="false">
</s:action>
推荐至<select name="recommendRegionId" class="inp_select">
	...
	<option value="<s:property value="#recommendRegion.id"/>"><s:property value="#recommendRegion.name"/></option>
	</s:iterator>
</select>
<input type="submit" value="推荐" class="inp_btn">
</s:elseif>
</form>

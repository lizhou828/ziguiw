...
document.write("亲，推荐知识成功，去继续推荐知识充实你的内容吧");

document.write("<br /><a href='<%=path%>/admin/knowledge/knowledge_listKnowledgesByCondition.action?opType=3&query.state=2'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/knowledge/knowledge_listKnowledgesByCondition.action?opType=3&query.state=2")',5000);</script>

...
document.write("亲，删除辩论成功！");

document.write("<br /><a href='<%=path%>/admin/knowledge/debate_listByCondition.jsp?opType=0'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/knowledge/debate_listByCondition.jsp?opType=0")',5000);</script>

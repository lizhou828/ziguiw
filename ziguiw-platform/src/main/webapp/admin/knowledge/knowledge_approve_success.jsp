...
document.write("亲，您已经成功审批了知识，可以继续审批！");

document.write("<br /><a href='<%=path%>/admin/knowledge/knowledge_listKnowledgesByCondition.action?opType=1&query.state=1'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/knowledge/knowledge_listKnowledgesByCondition.action?opType=1&query.state=1")',5000);</script>

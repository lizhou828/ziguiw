...
document.write("亲，该提问评审成功，可以继续评审其他提问！");

document.write("<br /><a href='<%=path%>/admin/knowledge/question_listByCondition.action?opType=1&query.state=1'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/knowledge/question_listByCondition.action?opType=1&query.state=1")',5000);</script>

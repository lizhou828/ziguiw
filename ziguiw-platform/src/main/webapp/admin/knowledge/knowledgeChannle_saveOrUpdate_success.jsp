...
document.write("恭喜您，新增频道成功！");

document.write("<br /><a href='<%=path%>/admin/knowledge/knowledgeChannle_getAll.action'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/knowledge/knowledgeChannle_getAll.action")',5000);</script>

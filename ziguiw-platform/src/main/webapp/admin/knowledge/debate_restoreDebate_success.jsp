...
document.write("亲，恢复辩论成功，可以继续恢复其他辩论！");

document.write("<br /><a href='<%=path%>/admin/knowledge/debate_listByCondition.action?opType=2&query.state=-1'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/knowledge/debate_listByCondition.action?opType=2&query.state=-1")',5000);</script>

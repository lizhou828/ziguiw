...
document.write("<br /><a href='<%=path%>/admin/news/news_listNewsByCondition.action?opType=1&query.state=1'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/news/news_listNewsByCondition.action?opType=1&query.state=1")',5000);</script>

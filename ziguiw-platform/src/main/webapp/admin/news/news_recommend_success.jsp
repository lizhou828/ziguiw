...
document.write("亲，保存推荐区成功，去多新增新闻充实你的内容吧");

document.write("<br /><a href='<%=path%>/admin/news/news_listNewsByCondition.action?opType=3&query.state=2'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/news/news_listNewsByCondition.action?opType=3&query.state=2")',5000);</script>

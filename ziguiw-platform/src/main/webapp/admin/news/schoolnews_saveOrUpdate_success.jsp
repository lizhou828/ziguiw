...
<div class="right">
    ...
    <center>
        ...
        <script>
            ...
            document.write("<br /><a href='<%=path%>/admin/news/schoolNews_listByCondition.action'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

            setTimeout('JumpUrl("<%=path%>/admin/news/schoolNews_listByCondition.action")',5000);</script>

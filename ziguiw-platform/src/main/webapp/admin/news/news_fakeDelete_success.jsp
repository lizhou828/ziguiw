...
document.write("亲，您已经将这些不顺眼的新闻删除，如果后悔可以去恢复哦");

document.write("<br /><a href='<%=path%>/admin/news/news_listNewsByCondition.jsp'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/news/news_listNewsByCondition.jsp")',5000);</script>

        ...
        <script>
            ...
            function JumpUrl(url){
                ...
                if(pgo==0){ if(url != null){
                    ...
                    location='classPhoto_list.action';
                }
                    pgo=1;
                }
            ...
            document.write("<br /><a href='classPhoto_list.action'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

            setTimeout('JumpUrl("classPhoto_list.action")',1000);</script>

...
document.write("<br /><a href='admin/auth/authority_getAll.jsp?opType=0'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/auth/authority_getAll.jsp?opType=0")',2000);</script>

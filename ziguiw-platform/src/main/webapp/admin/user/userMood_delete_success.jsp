...
document.write("亲，您已经成功删除了该说说！");

document.write("<br /><a href='<%=path%>/admin/user/userMood_listByCondition_success.jsp?opType=0'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/user/userMood_listByCondition_success.jsp?opType=0")',5000);</script>

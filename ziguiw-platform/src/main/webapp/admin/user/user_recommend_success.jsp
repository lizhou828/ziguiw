...
document.write("亲，您已经成功推荐了这个用户");

document.write("<br /><a href='<%=path%>/admin/user/user_listByCondition_success.jsp?opType=0'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/user/user_listByCondition_success.jsp?opType=0")',5000);</script>

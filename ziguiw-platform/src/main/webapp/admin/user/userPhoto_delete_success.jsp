...
document.write("<br /><a href='<%=path%>/admin/user/userPhoto_listByCondition_success.jsp?opType=0'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/user/userPhoto_listByCondition_success.jsp?opType=0")',5000);</script>

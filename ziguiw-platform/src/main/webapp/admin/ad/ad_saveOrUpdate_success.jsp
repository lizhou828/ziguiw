...
document.write("<br /><a href='<%=path%>/admin/ad/ad_getPlansByType.action'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/ad/ad_getAll.action")',5000);</script>

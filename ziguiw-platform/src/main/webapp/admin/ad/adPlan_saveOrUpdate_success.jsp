...
document.write("亲，保存广告计划成功");

document.write("<br /><a href='<%=path%>/admin/ad/adPlan_getPlansByType.action?type=new'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/ad/adPlan_getPlansByType.action?type=new")',2000);</script>

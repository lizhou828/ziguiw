...
<table class="table">
	...
	<s:action var="getVipStudents" name="commonQuery" namespace="/" executeResult="false" ignoreContextParams="false">
     	<s:param name="hql">select st from UserBase as ub, Student as st  where ub.type = 4 and ub.foreignKey = st.Xs_id and ub.state < 5</s:param>
	...
	<tr>
		<td>
			<s:property value="#student.user.nickName"/>
		</td>
		<td>

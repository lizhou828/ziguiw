...
document.write("<br /><a href='<%=path%>/admin/config/configCenter_getConfig.action'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/config/configCenter_getConfig.action")',2000);</script>

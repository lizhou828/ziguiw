...
document.write("亲，密码修改成功");

document.write("<br /><a href='<%=path%>/admin/myConsole/index.jsp'>如果你的浏览器没反应，请点击这里...</a><br/></div>");

setTimeout('JumpUrl("<%=path%>/admin/myConsole/index.jsp")',1000);</script>

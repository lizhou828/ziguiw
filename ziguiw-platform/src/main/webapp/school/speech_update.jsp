...
<div class="content clearfix pr">
	...
	<form action="<%=path%>/user/speech_save.action"  method="post">

    <div class="ask_and_sea found w-760 hei-700  r" style="min-height:550px">
       	<h2 class="col-h3">校长致辞</h2>

		<div class="hei-400">
		<div class="art_zw">
					<textarea name="schoolInfo.speech" cols="100" rows="8" style="width:700px;height:500px;" id="content1"><s:property value="schoolInfo.speech" escape="false"/></textarea>
			</div>
		</div>

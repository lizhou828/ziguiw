...
<div class="content clearfix pr">
	...
	<!--ad01 E -->
	<form action="<%=path%>/user/summary_save.action" method="post">
    <div class="ask_and_sea found w-760 r" style="min-height:550px">
       	<h2 class="col-h3">学校概况</h2>

		<div class="hei-400">
		<div class="art_zw">
					<textarea name="schoolInfo.summary" cols="100" rows="8" style="width:700px;height:500px;" id="content1"><s:property value="schoolInfo.summary" escape="false"/></textarea>
			</div>
		</div>

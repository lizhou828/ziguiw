...
<div class="content clearfix pr">
	...
	<!--ad01 E -->
    <div class="ask_and_sea found w-760 hei-700  r" style="height:550px">
       	<h2 class="col-h3">招聘信息</h2>

		<div class="hei-400">
		<p>
			<s:property value="schoolInfo.job" escape="false"/>
		</p>
		<a href="<%=path%>/user/job_prepare_update.action"><input type="button" class="btn2 r mt5" value="修改"></a>
		</div>

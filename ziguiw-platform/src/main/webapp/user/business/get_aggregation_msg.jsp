...
<div class="content clearfix pr">
	...
	<div class="w-760 r userCenterContent"
		style="margin-left: -110px; width: 1800px; zoom: 1px; min-height:550px;">
		<h2 class="title">信息中心</h2>
		<div class="title-bottom">.</div>
		<!--列表样式1-->
		<div class=" w-520 my_mid" style="margin-left:10px;width:700px">	
	
		<form action="<%=path%>/info/mail_saveOrUpdate.action" method="post">		
			<div class="">
			...
			<input type="hidden" name="commonMessage.kind" value="3" />
			<br/>
			...
			<div class="mes_list_r" style="margin-left: 0px">
				<label class="gray">
				 <s:property value="#message.formUser.realName" /> <s:property
						value="#message.formatedCreateDate" /> 留言</label>
				<p class="block">

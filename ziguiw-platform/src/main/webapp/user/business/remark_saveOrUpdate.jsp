...
<div class="w-760 r userCenterContent" >
        ...
        <!--表单样式2-->
        	<form method="post" action="<%=path%>/info/remark_saveOrUpdate.action">
            <fieldset class="formStyle2 clearfix" style="">
                ...
                <ul>
                	...
                	<div class="label">班级：</div>
				     ...
				     <tr>
                     <td width="110"  align="right" style=" vertical-align:top;">选择学生：</td>
				      <td width="110">
                	...
                	<li>
                		<div class="label">内容：</div><div>
                		<textarea class="field-400" style="height:200px;"  rows="4" name="commonMessage.text" type="text">${commonMessage.text}</textarea>
                		</div>
                	</li>
            	</ul>

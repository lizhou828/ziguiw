...
<div class="ask_and_sea found w-760 hei-700 r ">
	...
	<table class="listStyle1" cellpadding="2" cellspacing="2" border="0" >
		...
		<thead>
			<tr>
               	<td class="field1 datetime" width="30%">学期</td>
               	<td class="light" width="20%">考试科目</td>
               	<td class="light" width="20%">成绩</td>
               </tr>
		</thead>
	    <s:iterator value="datas.list" var="data">
           	<tr>
               	<td class="field1 datetime"><s:property value="#data.TERM_NAME"/></td>
               	<td class="light"><s:property value="#data.EXAM_NAME"/></td>
               	<td class="light"><s:property value="#data.cj.cj"/></td>
               </tr>

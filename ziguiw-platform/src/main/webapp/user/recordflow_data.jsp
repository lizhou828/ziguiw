...
<div class="ask_and_sea found w-760 hei-700 r ">
	...
	<table class="listStyle1" cellpadding="2" cellspacing="2" border="0" >
		...
		<thead>
			<tr>
               	<td class="field1 datetime" width="30%">消费时间</td>
               	<td class="light" width="20%">消费金额</td>
               	<td class="light" width="20%">余额</td>
               </tr>
		</thead>
	    <s:iterator value="datas.list" var="data">
           	<tr>
               	<td class="field1 datetime"><s:property value="#data.CONS_TIME"/></td>
               	<td class="light"><s:property value="#data.CONS_FARE"/></td>
               	<td class="light"><s:property value="#data.X_MONEY"/></td>
               </tr>

...
<div class="content clearfix">
    ...
    <div class="col1 fl">
    	...
    	<@dataFunction function="questionsByStatus" pageNo="${(parameter.pageNo[0])!1}" pageSize="24" status="${parameter.status[0]}">
    		<ul class="ul_sign_3">
        	...
        	<div class="pagenum"><@pager.p page="${functionData.currentPage}" totalpage="${functionData.pageCount}" params='templateName=question_list.ftl&status=${parameter.status[0]}'/></div>
    	 </@dataFunction>
    	</div>
    </div>

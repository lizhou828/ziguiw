    ...
    <script type="text/javascript">
        $().ready(function(){
            $("input[name='studentId']").change(function(){
                window.location="/userCenterWap/showSchoolNotice.action?studentId="+$(this).val();
            });
        });
    </script>
...
<body>
    ...
    <div class="bobti">
        学校公告<span style="color:#2d2d2d;font-family:Arial, Helvetica, sans-serif;font-weight:normal;font-size:12px;"></span>
    </div>
    <div class="xunc_1-1">
    ...
    <div class="notice_con">
        <form action="/userCenterWap/showSchoolNotice.action" id="schoolNoticeForm">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <c:forEach items="${map['data']}" var="notice">
                        <tr>
                            <th >${data['MSG_CONTENT']}</th>
                            <th > ${data['PUB_DATE']}</th>
                        </tr>
                    </c:forEach>
                </c:otherwise>

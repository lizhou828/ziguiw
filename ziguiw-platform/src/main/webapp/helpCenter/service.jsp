...
<!--	<base href="http://www.ziguiw.com:80/"/>-->
		...
		<link type="text/css" rel="stylesheet" href="/css/basc.css">        
		<base target="_blank"/>		
	<script>
        function dj(i)
        {
    	...
    	<div class="p_middle">
        	<div class="p_middle_left" id="knowqqleft">
            	<ul>
                	...
                	<li><a href="service.jsp" id="on">客服中心</a></li>
            ...
            <div class="p_middle_right">
                <div class="p_title"><p><em>&#8226;</em>客服中心</p></div>
                ...
                <div class="p_con">
                    ...
                    <div class="p_con_l">
                        <jsp:include page="column.jsp">
                            <jsp:param name="columnId" value="1"></jsp:param>
                            <jsp:param name="columnName" value="常见问题"></jsp:param>
                        </jsp:include>
                    </div>
                    <div class="p_con_r">
                        <jsp:include page="column.jsp">
                            <jsp:param name="columnId" value="2"></jsp:param>
                            <jsp:param name="columnName" value="网站公告"></jsp:param>
                        </jsp:include>
                    </div>

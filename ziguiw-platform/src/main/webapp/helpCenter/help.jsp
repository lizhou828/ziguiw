    ...
    <!--middle B-->
    	<div class="p_middle">
            ...
            <div class="p_middle_right">
                <div class="p_title"><p><em>&#8226;</em>帮助中心</p></div>
                                
                <div class="p_con_l">
                    <div class="p_help_middle">
                    	<p><strong>如何注册注册子贵网会员？	</strong><!--<span class="helpmore">更多 &gt;&gt;</span>--></p>
                        <hr style="margin:8px;"/>
                        <div class="p_help_c">
                        	<ul>
                            	<li><a  href="helpcon.jsp">如何注册注册子贵网会员？</a></li>
                            	<li><a  href="helpcon.jsp?">内容标题2</a></li>
                            	<li><a  href="helpcon.jsp?">内容标题3</a></li>
                            	<li><a  href="helpcon.jsp?">内容标题4</a></li>
                            	<li><a  href="helpcon.jsp?">内容标题5</a></li>
                            	<li><a  href="helpcon.jsp?">内容标题6</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="p_con_r">
                    <div class="p_help_middle">
                    	<p><strong>网站的栏目功能：</strong><!--<span class="helpmore">更多 &gt;&gt;</span>--></p>
                        <hr style="margin:8px;"/>
                        <div class="p_help_c">
                        	<ul>
                            	<li><a href="/news/index">教育在线</a></li>
                            	<li><a href="/study/index">教育知识</a></li>
                            	<li><a href="http://dsis.ziguiw.com/source/sourceInfo.action">教育资源</a></li>
                            	<li><a href="/community/index">互动社区</a></li>
                            	<li><a href="/user/home_index.jsp">我的小家</a></li>
                            	<li><a href="http://dsis.ziguiw.com/">数字校园功能</a></li>
                            </ul>
                          </div>
                    </div>
